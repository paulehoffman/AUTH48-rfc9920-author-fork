...
<!--[authors] We see that you greatly reorganized this section because is just repeated what was said in {{rfc-consumers-definition}}.
We doubt that this is what the RSWG would want.
Instead, we have just reduced the section to a see reference with a very brief explanation.
-->

The text in {{rfc-consumers-definition}} of this document, concerning RFC consumers, is all new.
