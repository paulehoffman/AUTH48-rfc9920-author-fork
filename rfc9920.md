...
<!--[authors] This is the wording from RFC 9820, and we purposely did not change this type of wording in this RFC. If the RPC wants to now update the wording to be consistent, that's fine, but maybe it is odd to do so now.
-->
...
As these structures and processes have been exercised, the community has found places where can might be improved.
